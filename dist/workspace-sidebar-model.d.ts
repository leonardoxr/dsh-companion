...
export declare function remoteId(hostId: string, id: string): string;
export interface RemoteRef {
    hostId: string;
    id: string;
}
/** Split a synthetic remote id back into its host and native halves. */
export declare function parseRemoteId(id: string): RemoteRef | undefined;
/**
 ...
 */
export declare function externalRows(snapshot: NativeWorkspaceSnapshot | null, currentOrigin: string): NativeWorkspaceRow[];
 ...
 */
export declare function remoteWorkspaceViews(snapshot: NativeWorkspaceSnapshot | null, currentOrigin: string): MergedWorkspaceView[];
/**
 ...
 */
export declare function remoteSessionSummaries(snapshot: NativeWorkspaceSnapshot | null, currentOrigin: string): MergedSessionSummary[];
 ...
 */
export declare function mergedSessionList<T extends SessionListStateCore>(local: T, snapshot: NativeWorkspaceSnapshot | null, currentOrigin: string): T;
/**
 ...
 */
export declare function mergedWorkspaceList<T extends WorkspaceListStateCore>(local: T, snapshot: NativeWorkspaceSnapshot | null, currentOrigin: string): T;
